...
public class RedworldFruitDecorator extends CocoaDecorator {
	public static Codec<RedworldFruitDecorator> CODEC = Codec.unit(RedworldFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("redworld_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public RedworldFruitDecorator() {
		super(0.2f);
	}
