package net.mcreator.hongxusworld.world.features.treedecorators;
...
public class RedworldLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(RedworldLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("redworld_tree_leave_decorator", DECORATOR_TYPE));
	}

	public RedworldLeaveDecorator() {
		super(0.25f);
	}
